...
CREATE TABLE IF NOT EXISTS `citas` (
  ...
  CONSTRAINT `FK__doctores` FOREIGN KEY (`doctor_id`) REFERENCES `doctores` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
DELETE FROM `citas`;
INSERT INTO `citas` (`id`, `fecha`, `doctor_id`, `paciente_id`, `hora`, `consultorio`) VALUES
	(4, '2024-02-14', 1, 1, '03:05:01', 345);
...
INSERT INTO `pacientes` (`nombre`, `apellido`, `n_documento`, `celular`, `id`) VALUES
	('Juan', 'Hernandez', 1788676268, 12312323, 1),
	('amber', 'lopez', 2312124232, 543553453, 2);
